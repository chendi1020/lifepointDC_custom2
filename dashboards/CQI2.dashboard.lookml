- dashboard: cqi_2
  ...
  - title: AsterPlot
    ...
    fields: [lp_demo.division, lp_demo.cqi_metric_original_rate, lp_demo.number_of_patients_with_gaps_in_care]
    filters: {}
  ...
  - name: Region
    title: Region
    type: field_filter
    default_value: Mountain Division,Duke LifePoint Healthcare,Regional Health Network,Central
